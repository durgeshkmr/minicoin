...
#ifndef MINICOIN_TEST_SCRIPTNUM10_H
#define MINICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Minicoin Core 0.10.0, for cross-comparison.
 */
public:
