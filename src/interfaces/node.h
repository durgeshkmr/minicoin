...
#ifndef MINICOIN_INTERFACES_NODE_H
#define MINICOIN_INTERFACES_NODE_H
...
//! Top-level interface for a minicoin node (minicoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // MINICOIN_INTERFACES_NODE_H
