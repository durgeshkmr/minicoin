...
#ifndef MINICOIN_QT_MINICOINUNITS_H
#define MINICOIN_QT_MINICOINUNITS_H
...
/** Minicoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MinicoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MinicoinUnits(QObject *parent);

    /** Minicoin units.
      @note Source: https://en.minicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MNC,
...
typedef MinicoinUnits::Unit MinicoinUnit;

#endif // MINICOIN_QT_MINICOINUNITS_H
