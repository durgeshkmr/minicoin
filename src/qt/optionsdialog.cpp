    ...
    mapper(0)
{
    ...
    ui->minicoinAtStartup->setToolTip(ui->minicoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->minicoinAtStartup->setText(ui->minicoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openMinicoinConfButton->setToolTip(ui->openMinicoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new MinicoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->minicoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMinicoinConfButton_clicked()
{
