 ...
 */
#ifndef MINICOIN_UTIL_H
#define MINICOIN_UTIL_H
...
extern const char * const MINICOIN_CONF_FILENAME;
extern const char * const MINICOIN_PID_FILENAME;
...
{
    std::string s = strprintf("minicoin-%s", name);
