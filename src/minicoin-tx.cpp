...
static void SetupMinicoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " minicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  minicoin-tx [options] <hex-tx> [commands]  Update hex-encoded minicoin transaction\n" +
            "or:     minicoin-tx [options] -create [commands]   Create hex-encoded minicoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded minicoin transaction
