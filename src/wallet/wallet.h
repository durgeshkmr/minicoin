...
#ifndef MINICOIN_WALLET_WALLET_H
#define MINICOIN_WALLET_WALLET_H
...
public:
     ...
     * on this minicoin node, and set to 0 for transactions that were created
...
#endif // MINICOIN_WALLET_WALLET_H
