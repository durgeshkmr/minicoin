...
* minicoin.conf: contains configuration settings for minicoind or minicoin-qt
* minicoind.pid: stores the process id of minicoind while running
...
* debug.log: contains debug information and general logging generated by minicoind or minicoin-qt
