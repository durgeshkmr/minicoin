...
# TestP2PConn: A peer we use to send messages to minicoind, and store responses.
...
class CompactBlocksTest(MinicoinTestFramework):
    ...
    # This test actually causes minicoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that minicoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for minicoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # minicoind will not send blocktxn responses for blocks whose height is
