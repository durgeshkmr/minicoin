...
class WalletTest(MinicoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 MNC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 mnc in block rewards plus fees, but
        ...
        # Send 10 MNC with subtract fee from amount
        ...
        # Sendmany 10 MNC with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/minicoin/minicoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
