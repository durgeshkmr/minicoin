...
"""Verify that starting minicoin with -h works as expected."""

from test_framework.test_framework import MinicoinTestFramework
from test_framework.util import assert_equal

class HelpTest(MinicoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start minicoin with -h for help text")
        ...
        self.log.info("Start minicoin with -version for version information")
        ...
        self.log.info("Start minicoind with -fakearg to make sure it does not start")
